...
namespace HabiCS.UI
{
    public class Label: IUIElem
    {
        ...
        {
            List<VertexTexture> verts = new List<VertexTexture>();
            ...
            foreach (var item in _text.Text)
            {
                ...
                verts.Add(new VertexTexture(xpos, ypos, -1.0f, u1, v2));
                verts.Add(new VertexTexture(xpos, ypos + _bounds.Size.Y, -1.0f, u1, v1));
                verts.Add(new VertexTexture(xpos + stepX, ypos, -1.0f, u2, v2));
                verts.Add(new VertexTexture(xpos + stepX, ypos + _bounds.Size.Y, -1.0f, u2, v1));
            ...
            _mesh.BuildText(verts.ToArray(), new UIMesh.Attribute[]{
                new UIMesh.Attribute(0,3, VertexTexture.SizeInBytes, 0),
                new UIMesh.Attribute(1,2, VertexTexture.SizeInBytes, Vector3.SizeInBytes)
            });
